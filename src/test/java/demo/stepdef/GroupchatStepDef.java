...
public class GroupchatStepDef {
    ...
    public void showProfileLeaveGroupAndLogout(){groupChatPages.profileBtnLeaveGroupBtnLogoutBtn();}

    @When("Click profile icon")
    public void clickProfileIcon(){groupChatPages.clickBtnProfile();}

    @Then("directed to profile")
    public void directedToProfile(){profilePages.profileIsDisplayed();}

    @When("Click leave group icon")
    public void clickLeaveGroupIcon(){groupChatPages.clickBtnLeave();}

    @Then("directed to home page")
    public void directedToHomepage(){homepagePages.homepageIsDisplayed();}

    @When("Click logout group icon")
    public void clickLogoutIcon(){groupChatPages.clickBtnLogout();}

    @Then("directed to login page")
    public void directedToLoginpage(){loginPages.isLoginPageDisplayed();}

    @When("Click SOS icon")
    public void clickSOSIcon(){groupChatPages.clickBtnSOS();}

    @Then("Show SOS page")
    public void showSOSPage(){groupChatPages.sOSPageIsDisplayed();}

    @When("Click chat field")
    public void clickChatField(){groupChatPages.clickFieldChat();}
    ...
    public void clickSendButton(){groupChatPages.clickBtnSend();}
